 ...
 * 三地址码在 LR 规约时由 {@link compiler.parser.SemanticReduceHandler} 生成并放入
...
public class SemanticAnalyzerImpl implements SemanticAnalyzer {
    ...
    private void handleDeclare(
        ...
        symbolTable.define(new Symbol(name, type, kind, arrayLength, symbolTable.currentScopeDepth()));
    }
